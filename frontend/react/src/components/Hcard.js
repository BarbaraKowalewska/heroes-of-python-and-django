                ...
                function (category) {
                    return <Card style={divStyle}>
                        <CardImg top width="100%"
                                 ...
                                 alt="Card image cap"/>
                        <h2 style={pStyle} className="card-title" align="center">{category.name}</h2>
                        <CardText style={pStyle} align="center">{category.summary}</CardText>
